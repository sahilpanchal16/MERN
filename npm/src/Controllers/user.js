...
const createUser = async (req, res) => {
  try {
    const { username, email, password, accouttype } = req.body;
    if (!username || !email || !password || !accouttype) {
    ...
    await Users.create({ username, email, accouttype, password: hashedPassword });
